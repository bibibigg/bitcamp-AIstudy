...
model.load_weights('./_save/tf17_wine.h5') # 모델을 살리는 이유는 가중치만 저장하였기에 모델이 필요
# model.save('./_save/tf15_wine.h5')


# 3. 컴파일, 훈련

model.compile(loss='sparse_categorical_crossentropy', optimizer='adam', metrics=['accuracy']) # fit에서 나온 가중치로 컴파일을 하기에 fit은 필요가없음
...
# loss :  0.08650974184274673
# acc :  0.9444444179534912
# 걸린 시간 21.073065280914307